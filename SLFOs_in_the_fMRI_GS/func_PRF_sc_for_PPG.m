function [obj_function,CRF_sc,RRF_sc,r_PRF_sc,yPred, yPred_card, yPred_resp]=func_PRF_sc_for_PPG(P,Ts_10,HR,RF,ind_BOLD_10,GS,only_OF, ind_train, ind_valid,filt_b, filt_a)
