function [obj_function,CRF_sc,RRF_sc,HR_conv,RF_conv,r_PRF_sc,yPred, HR_conv_MR, RF_conv_MR]=func_PRF_sc(P,Ts_10,HR,RF,ind_BOLD_10,GS,only_OF, ind_train, ind_valid,filt_b, filt_a)
...
if only_OF == 0
    ...
    yPred_card = regr(:,2:3)*B(2:3);  r_PRF_sc(2) = corr(yPred_card(ind_valid),GS(ind_valid));
    yPred_resp = regr(:,4:5)*B(4:5);  r_PRF_sc(3) = corr(yPred_resp(ind_valid),GS(ind_valid));
end
