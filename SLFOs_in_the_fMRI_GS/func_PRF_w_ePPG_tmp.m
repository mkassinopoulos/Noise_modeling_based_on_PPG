function [obj_function,CRF_sc,RRF_sc,BRF_sc, r_PRF_sc,yPred, yPred_card, yPred_resp, yPred_PPG]=func_PRF_w_ePPG_tmp(P,Ts_10,HR,RF,ePPG, ind_BOLD_10,GS,only_OF,ind_train, ind_valid, filt_b, filt_a)
...
PPG_Fconv=conv(ePPG,IR_ppgF); PPG_Fconv_MR=PPG_Fconv(ind_BOLD_10+0*10);
PPG_Sconv=conv(ePPG,IR_ppgS); PPG_Sconv_MR=PPG_Sconv(ind_BOLD_10+0*10);
